...
Read in **OnlineNewsPopularity.csv**. The data set was download from [this website](https://archive.ics.uci.edu/ml/datasets/Online+News+Popularity). Keep the `share` variable, the four predictor variables mentioned above, and the variables that indicated the weekday the article was published. Change `shares` into a binary classification by splitting it into two groups - <1400 and ≥1400.  
